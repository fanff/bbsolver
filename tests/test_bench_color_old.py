...
def color_dataset():
    ...
    for i in range(NUM_TUPLES):
        ...
        ct = tuple(ColorEnum.from_str(value_to_str[v]) for v in vals)
        tuples.append(ct)
    ...
    missing = tuple(ColorEnum.from_str(value_to_str[v]) for v in missing_vals)
